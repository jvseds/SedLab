...
ggplot(df, aes(x = planktic_percent)) +
  geom_histogram(binwidth = 0.05, fill = "#00c2c7", color = "#005582") +
  geom_density(alpha = 0.3, color = "#03396c", linewidth = 0.72) +
  facet_wrap(~core) +
  labs(x = "Planktic Fraction", y = "Number of Samples", title = "Distribution of Planktic Fraction by Core") +
  theme(plot.title = element_text(hjust = 0.5))

# ggsave("plankt-distribution.png", width = 6, height = 4, dpi = 350)
```
...
# ggsave("plankt-depth-effect.png", width = 6, height = 4, dpi = 350)
```
...
ggplot(mean_plot, aes(x = core, y = estimate__, color = core)) +
  ...
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_manual(values = c("#0086ac", "#03396c"))

# ggsave("plankt-mean-comparison.png", width = 6, height = 4, dpi = 350)
